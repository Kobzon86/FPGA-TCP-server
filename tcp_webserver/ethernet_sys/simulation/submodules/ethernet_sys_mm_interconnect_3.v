// ethernet_sys_mm_interconnect_3.v
...
`timescale 1 ps / 1 ps
module ethernet_sys_mm_interconnect_3 (
	...
	ethernet_sys_mm_interconnect_3_router router (
	...
	ethernet_sys_mm_interconnect_3_router router_001 (
	...
	ethernet_sys_mm_interconnect_3_router_002 router_002 (
	...
	ethernet_sys_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_3_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_3_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_3_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
