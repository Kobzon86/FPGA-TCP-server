// ethernet_sys_mm_interconnect_2.v
...
`timescale 1 ps / 1 ps
module ethernet_sys_mm_interconnect_2 (
		...
		input  wire [3:0]  sgdma_1_m_write_byteenable,                //                                    .byteenable
		input  wire        sgdma_1_m_write_write,                     //                                    .write
		input  wire [31:0] sgdma_1_m_write_writedata,                 //                                    .writedata
	...
	wire          rsp_mux_src_valid;                                                  // rsp_mux:src_valid -> sgdma_0_m_read_agent:rp_valid
	wire  [101:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> sgdma_0_m_read_agent:rp_data
	wire          rsp_mux_src_ready;                                                  // sgdma_0_m_read_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> sgdma_0_m_read_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                          // rsp_mux:src_startofpacket -> sgdma_0_m_read_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                            // rsp_mux:src_endofpacket -> sgdma_0_m_read_agent:rp_endofpacket
	...
	wire   [31:0] sgdma_1_m_write_translator_avalon_universal_master_0_readdata;      // sgdma_1_m_write_agent:av_readdata -> sgdma_1_m_write_translator:uav_readdata
	...
	wire    [3:0] sgdma_1_m_write_translator_avalon_universal_master_0_byteenable;    // sgdma_1_m_write_translator:uav_byteenable -> sgdma_1_m_write_agent:av_byteenable
	...
	wire   [31:0] sgdma_1_m_write_translator_avalon_universal_master_0_writedata;     // sgdma_1_m_write_translator:uav_writedata -> sgdma_1_m_write_agent:av_writedata
	wire    [2:0] sgdma_1_m_write_translator_avalon_universal_master_0_burstcount;    // sgdma_1_m_write_translator:uav_burstcount -> sgdma_1_m_write_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                              // rsp_mux_001:src_valid -> sgdma_1_m_write_agent:rp_valid
	wire  [101:0] rsp_mux_001_src_data;                                               // rsp_mux_001:src_data -> sgdma_1_m_write_agent:rp_data
	wire          rsp_mux_001_src_ready;                                              // sgdma_1_m_write_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                            // rsp_mux_001:src_channel -> sgdma_1_m_write_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                      // rsp_mux_001:src_startofpacket -> sgdma_1_m_write_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                        // rsp_mux_001:src_endofpacket -> sgdma_1_m_write_agent:rp_endofpacket
	...
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire          sgdma_0_m_read_agent_cp_valid;                                      // sgdma_0_m_read_agent:cp_valid -> router:sink_valid
	wire  [101:0] sgdma_0_m_read_agent_cp_data;                                       // sgdma_0_m_read_agent:cp_data -> router:sink_data
	wire          sgdma_0_m_read_agent_cp_ready;                                      // router:sink_ready -> sgdma_0_m_read_agent:cp_ready
	wire          sgdma_0_m_read_agent_cp_startofpacket;                              // sgdma_0_m_read_agent:cp_startofpacket -> router:sink_startofpacket
	wire          sgdma_0_m_read_agent_cp_endofpacket;                                // sgdma_0_m_read_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          sgdma_1_m_write_agent_cp_valid;                                     // sgdma_1_m_write_agent:cp_valid -> router_001:sink_valid
	wire  [101:0] sgdma_1_m_write_agent_cp_data;                                      // sgdma_1_m_write_agent:cp_data -> router_001:sink_data
	wire          sgdma_1_m_write_agent_cp_ready;                                     // router_001:sink_ready -> sgdma_1_m_write_agent:cp_ready
	wire          sgdma_1_m_write_agent_cp_startofpacket;                             // sgdma_1_m_write_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          sgdma_1_m_write_agent_cp_endofpacket;                               // sgdma_1_m_write_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [101:0] onchip_memory2_0_s1_agent_rp_data;                                  // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	altera_merlin_master_translator #(
		...
		.av_byteenable          (sgdma_1_m_write_byteenable),                                         //                          .byteenable
	...
	ethernet_sys_mm_interconnect_2_router router (
	...
	ethernet_sys_mm_interconnect_2_router router_001 (
	...
	ethernet_sys_mm_interconnect_2_router_002 router_002 (
	...
	ethernet_sys_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_1_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_2_cmd_demux cmd_demux_001 (
		.clk                (clk_1_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_1_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (clk_1_clk_clk),                             //       clk.clk
		.reset              (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_1_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ethernet_sys_mm_interconnect_2_rsp_mux rsp_mux_001 (
		.clk                 (clk_1_clk_clk),                             //       clk.clk
		.reset               (sgdma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
